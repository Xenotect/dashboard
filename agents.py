...
- Case Study: ยกตัวอย่างลูกค้าจริง ก่อน→หลัง ผลลัพธ์ชัดเจน ดูมีความรู้ ได้สาระ
...
- Hard Sell: สร้างแรงกดดัน urgency สูง "อย่าพลาด" "วันนี้เท่านั้น" หรือ ตระหนักถึงความคุ้มค่าที่ได้รับ คุณภาพสูงกว่าราคาที่จ่าย
- FOMO: กลัวพลาด "คนอื่นเขาทำแล้ว" "เหลือน้อย" "หมดแล้วหมดเลย" หรือ "เสียดายถ้าไม่ได้ทำ" "เสียโอกาสที่ไม่รู้จะมาอีกตอนไหน"
- Trust: สร้างความน่าเชื่อถือ ประสบการณ์ ความเชี่ยวชาญ การรับรอง ความจริงใจจากร้าน KUDOS
...
ห้ามถาม ห้ามอธิบาย ห้ามใส่หัวข้อ ตอบเป็น caption ภาษาไทยพร้อม emoji ไม่เกิน 1-3 อันเท่านั้น
ห้ามใส่ hashtag (#) ทุกกรณี
ห้ามใส่ข้อมูลติดต่อ เบอร์โทร Line ID หรือที่อยู่ใดๆ ทั้งสิ้น
เขียนแค่เนื้อหา caption เท่านั้น""",
    llm=my_llm, verbose=True, tools=fb_tools
)
